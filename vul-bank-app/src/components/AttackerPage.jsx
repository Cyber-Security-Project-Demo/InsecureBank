...
const AttackerPage = ({ onBack }) => {
  ...
  const [timeLeft, setTimeLeft] = useState(9 * 60 + 39);
  ...
  const renderPopup1 = () => (
    <div className="fixed inset-0 bg-gray-900/20 backdrop-blur-[2px] flex items-center justify-center z-50">
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-sm w-full mx-4 overflow-hidden">
        ...
        <div className="bg-gradient-to-b from-purple-500 via-pink-500 to-orange-500 text-white p-6 text-center">
          <div className="mb-4">
      ...
      <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 relative shadow-2xl">
        ...
        <div className="text-center">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-green-500 to-blue-500 text-white py-3 px-6 rounded-lg font-bold text-lg hover:opacity-90 transition duration-300"
          >
            🎁 CLAIM YOUR GIFT NOW! 🎁
          </button>
